...
pub struct x35_RequestUpload;

impl UdsService for x35_RequestUpload {
    const SID: u8 = 0x35;

    type Request<'a> = x35_RequestUploadRequest;
    type Response<'a> = x35_RequestUploadResponse;
}

#[allow(non_camel_case_types)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct x35_RequestUploadRequest {
    pub data_format_identifier: DataFormatIdentifier,
    pub memory: MemoryAddressAndSize,
}

impl x35_RequestUploadRequest {
...
impl<'a> TryFrom<&'a [u8]> for x35_RequestUploadRequest {
    type Error = UdsNrc;
...
impl TryTo for x35_RequestUploadRequest {
    type Error = UdsNrc;
...
impl<'a> UdsServiceRequest<'a> for x35_RequestUploadRequest {
...
#[allow(non_camel_case_types)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct x35_RequestUploadResponse {
    pub max_number_of_block_length: MaxNumberOfBlockLength,
}

impl x35_RequestUploadResponse {
...
impl<'a> TryFrom<&'a [u8]> for x35_RequestUploadResponse {
    type Error = UdsNrc;
...
impl TryTo for x35_RequestUploadResponse {
    type Error = UdsNrc;
...
impl<'a> UdsServiceResponse<'a> for x35_RequestUploadResponse {}
